...
export default function PrintToken() {
      ...
      <section class="bg-white dark:bg-gray-900">
        <div class="grid py-8 px-4 mx-auto max-w-screen-xl lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div class="place-self-center mr-auto lg:col-span-7">
            ...
            <p class="mt-8 mb-6 max-w-2xl font-light text-gray-500 lg:mb-1 md:text-lg lg:text-xl dark:text-gray-400">
              <form onSubmit={handleSubmit} class="flex items-center">
                ...
                <div class="relative w-full">
                  ...
                  <input
                    ...
                    placeholder="Enter token to print the token..."
                    required
                  ></input>
                </div>
                <button
          ...
          <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
            ...
            {tokenDetails ? (
              <div>
                <h2>Token Details:</h2>
                <p>Token ID: {tokenDetails.tokenId}</p>
                <p>Generation Time: {tokenDetails.tokenGenerationTime}</p>
                <p>Service ID: {tokenDetails.serviceId}</p>
                <p>Service Description: {tokenDetails.serviceDescription}</p>
                <p>Status: {tokenDetails.status}</p>
                <p>Expected Wait Time: {tokenDetails.expectedWaitTime}</p>
              </div>
            ) : (
              <p>enter valid token Id</p>
            )}
          </div>
        </div>
        <br></br>
